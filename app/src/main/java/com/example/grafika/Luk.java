...
public class Luk extends View {
    public Luk(Context context) {
        super(context);
    }
    public Luk(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public Luk(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected void onDraw(Canvas canvas){
        ...
        p.setColor(Color.parseColor("#80c940"));
        canvas.drawText("Luk ",szer-20,wys/2,p );
